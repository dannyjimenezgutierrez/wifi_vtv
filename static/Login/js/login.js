...
form.addEventListener('submit', async e => {
    ...
    // PASO 1: Primero autenticar en Flask
    try {
        const resp = await fetch('/entrar', {
            method: 'POST',
        ...
        if (!data.ok) {
            showToast('ACCESO DENEGADO', data.mensaje);
    ...
    // PASO 2: Sesión creada, ahora animar
